...
export const ABOUT_TEXT = `A dedicated tech enthusiast with a focus on Data Science, Machine Learning, and Robotic Process Automation (RPA), I’m skilled in building intelligent solutions across domains like predictive modeling, survey analysis, and automation. With a foundation in hands-on projects and certifications, including the IBM Machine Learning Specialization, my work spans dynamic roles such as Data Science Intern, RPA Developer, and Software Developer. My portfolio showcases a balance of cutting-edge technologies and real-world impact, from ML-based forecasting systems to autonomous solutions with ESP32 sensors. Driven to innovate, I thrive on creating seamless, scalable systems that enhance user experience and optimize performance.`;
...
export const PROJECTS = [
  ...
  },
  {
    ...
    technologies: ["Open CV", "Python", "Firebase"],
  },
  {
